...
const unsigned char PROGMEM flag0_bm[] = {0xE1,0x9F,0x81,0xE1,0x9E,0x80,0x80,0x80};
const unsigned char PROGMEM flag1_bm[] = {0xE1,0x9F,0x81,0xE1,0x9E,0x80,0x80,0x80};
const unsigned char PROGMEM flag2_bm[] = {0xB0,0xCF,0x81,0xB1,0xCF,0x80,0x80,0x80};
const unsigned char PROGMEM flag3_bm[] = {0x98,0xE7,0x81,0x99,0xE7,0x80,0x80,0x80};
const unsigned char PROGMEM flag4_bm[] = {0x8C,0xF3,0x81,0x8D,0xF3,0x80,0x80,0x80};
const unsigned char PROGMEM flag5_bm[] = {0x86,0xF9,0x81,0x87,0xF9,0x80,0x80,0x80};
const unsigned char PROGMEM flag6_bm[] = {0xC3,0xBD,0x81,0xC3,0xBC,0x80,0x80,0x80};

#define FLAG_COUNT 5
const unsigned char *flags_bm[] = {flag1_bm,flag2_bm,flag3_bm,flag4_bm,flag5_bm,flag6_bm};
...
void drawer_init() {
  if (splash) {
    splash = false;
    display.clearDisplay();
    display.drawBitmap(0,0,drawer_splash,W,H,1);
    display.display();
    ft = millis()+5000;
    while(!pad_check() && millis() < ft);
  }
